...
public final class BufferedImageCanvas extends Canvas {
	...
	/**
	 * The buffered image to be drawn
	 */
	private final BufferedImage bi;
	
	/**
	 * The 2D graphics object necessary to draw
	 */
	...
	/**
	 * Use this to create a new buffered image canvas
	 * 
	 * @param bufferedImage image with a buffer of image data
	 */
	...
	@Override
	public void clear() {
		this.g.setBackground(new Color(15,10,90));
