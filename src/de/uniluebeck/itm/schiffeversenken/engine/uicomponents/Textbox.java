...
public class Textbox extends Component implements Drawable, TextInput {
	...
	/**
	 * The Semaphore used to control access to cursorPosition
	 */
	protected final Semaphore bufferMutex;

	/**
	 * The StringBuilder used for the input of the Textbox
	 */
	protected StringBuilder textBuffer;
	
	/**
	 * This variable determines whether the cursor is active
	 */
	...
	/**
	 * Use this method to correct the cursorPosition if it goes out of bounds
	 */
