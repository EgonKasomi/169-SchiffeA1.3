...
public final class Checkbox extends Component implements Clickable, Drawable {
	...
	/**
	 * The text displayed by the check box
	 */
	private String text;
	
	/**
	 * This variable determines whether the check box has been checked
	 */
	...
	/**
	 * Use this method in order to retrieve the text of the check box
	 * 
	 * @return the text
	 */
	...
	/**
	 * Use this method in order to set the text of the check box 
	 * 
	...
	/**
	 * Use this method in order to retrieve the activation status of the check box 
	 * 
	 * @return activated
	 */
	...
	/**
	 * Use this method in order to set the activation status of the check box
	 * 
