...
public final class DropdownSelector<K> extends Component implements Clickable, Drawable, LateRendering {
	...
	/**
	 * The variable mapping keys to Strings
	 */
	private final Map<K, String> itemMap;

	/**
	 * The currently selected key of the selector
	 */
	private K currentSelection = null;
	
	/**
	 * The vector containing the coordinates of the last click
	 */
	private Vec2 lastClickposition = null;

	/**
	 * The expanded width of the selector
	 */
	private int expandedWidth;
	
	/**
	 * The expanded height of the selector
	 */
	private int expandedHeight;
	
	/**
	 * The last known height of the text
	 */
	private int lastTextHeight = 0;
	
	/**
	 * This variable determines whether the selector should be expanded
	 */
	...
	/**
	 * Use this method to compute the expanded dimensions of the selector
	 * 
	 * @param c The Canvas
	 */
