...
public class ListBox<E> extends Component implements Drawable, Clickable {
	...
	/**
	 * A callable that will be triggered when the plus button was pressed. It needs to return
	...
	/**
	 * This consumer will be called with the item to edit if the user wishes to do so.
	 */
	private final Consumer<E> editButtonConsumer;

    /**
     * The vector containing the coordinates of the latest click
     */
	private Vec2 latestClick;
    
	/**
	 * This number contains the positional scroll offset of the row
	 */
