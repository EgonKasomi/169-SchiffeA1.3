...
/**
 * This class is used to handle the end of the game
 * 
 * @author leondietrich
 *
 */
public class EndOfGameMenu {
    ...
    /**
     * The Scene for the menu at the end of the game
     */
	private final SmartScene<ComponentModel> scene;

    /**
     * Construct a new menu for the end of the game
     * 
     * @param gameModel the model of the game
     * @param playerWon Has the player won the game?
     */
	...
	/**
	 * Use this method in order to retrieve the scene for the menu at the end of the game
	 * @return scene
	 */
