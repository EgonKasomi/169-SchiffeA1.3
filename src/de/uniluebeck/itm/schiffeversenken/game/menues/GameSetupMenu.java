...
public class GameSetupMenu {
	...
	/**
	 * The scene for the setup menu
	 */
	private final SmartScene<ComponentModel> scene;
	
	/**
	 * The Textbox used to save the typed in name for the player.
	 * If no name has been typed in by the time the game is loading,
	 * the default name "Player 1" is used
	 */
	private final Textbox playerNameTextBox;
	
	/**
	 * The DropdownSelector for the rule set
	 */
	private final DropdownSelector<Ruleset> ruleSelector;
	
	/**
	 * The DropdownSelector for the difficulty of the enemy AI player
	 */
	private final DropdownSelector<Integer> hardnessSelector;
	
	/**
	 * The label announcing that the game is currently loading
	 */
	private final SimpleLabel loadingHintLabel;
	
	/**
	 * The controller of the game setup menu
	 */
	...
	/**
	 * Use this method in order to retrieve the scene for the setup menu
	 * @return scene
	 */
