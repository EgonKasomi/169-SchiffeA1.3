...
public final class Ruleset {
	 ...
	 * The first rule set
	 */
	public static final Ruleset OFFICIAL_FIRST_VERSION_RULESET = new Ruleset("official_version_1", false, 2, 1, 1, 1, 0, new Vec2(15, 15));
	
	/**
	 * The second rule set
	 */
	public static final Ruleset OFFICIAL_SECOND_VERSION_RULESET = new Ruleset("official_version_2", false, 1, 1, 1, 0, 1, new Vec2(15, 15));
