 ...
 * 
 * @author leondietrich, modified by I. Schumacher, B. Voss, F. Junghans
 * 
 */
public final class GameField {
	...
	public void placeShip(int posX, int posY, int length, boolean up, Ship shipToPlace) {
		//places the ship if its vertical
		if (up){
		...
		//places the ship if its horizontal
		else {
